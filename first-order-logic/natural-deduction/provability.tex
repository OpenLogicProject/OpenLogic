...
\tagitem{defAnd}{}{\iftag{probAnd}{Exercise}{If $\Gamma \Proves !A
    \land !B$, there is !!a{derivation} $\delta$ of $!A \land !B$ from
    $\Gamma$. Consider
\[
\AxiomC{}
\RightLabel{$\delta$}
...
\tagitem{defAnd}{}{\iftag{probAnd}{Exercise.}{If $\Gamma \Proves !A$
    as well as $\Gamma \Proves !B$, there are !!{derivation}s $\delta_1$
    of $!A$ and $\delta_2$ of $!B$ from $\Gamma$.  Consider
\[
\AxiomC{}
\RightLabel{$\delta_1$}
\DeduceC{$!A$}
...
\tagitem{defIf}{}{\iftag{probIf}{Exercise.}{Suppose that $\Gamma
    ...
    !!{derivation}s $\delta_1$ of $!A$ from $\Gamma$ and $\delta_2$ of $!A
...
\begin{proof}
Let $\delta$ be an !!{derivation} of $!A(c)$ from $\Gamma$.  By adding a
...
\tagitem{prvEx}{Suppose $\Gamma \Proves !A(t)$. Then there is a
  !!{derivation}~$\delta$ of $!A(t)$ from~$\Gamma$. The !!{derivation}
\[
\AxiomC{}
\RightLabel{$\delta$}
\DeduceC{$!A(t)$}
