...
The \emph{main connective} (or \emph{principal} connective) of a formula is the outermost connective of the formula (so atomic formulae have no main connective). For example, the main connective of $(\lnot !A)$ is $\lnot$, the main connective of $(!A \lor !B)$ is $\lor$, etc. 
