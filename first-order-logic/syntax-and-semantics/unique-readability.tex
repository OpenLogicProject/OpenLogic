...
\item \indcase{!A}{\Atom{R}{t_1,\dots,t_n}}{$l(\indfrm) = 2 + l(t_1) +
  \dots l(t_n) = 2 + r(t_1) = \dots + r(t_n) = r(\indfrm)$.}
...
\item \indcase{!A}{(!B \ast !C)}{By induction hypothesis, $l(!B) =
  r(!B)$ and $l(!C) = r(!C)$.  Thus $l(\indfrm) = 2 + l(!B) + l(!C) =
  2 + r(!B) + r(!C) = r(\indfrm)$.}
...
If $!A$ is an atomic !!{formula}, then it satisifes one, and only one
