...
\item
  \indcase{!A}{\Atom{R}{t_1, \ldots, t_k}}{let $\Sat{M}{\indfrm}[s]$. Then
    ...
    agree on all free !p{variable}, $\Value{t_i}{M}[s] = s(t_i) =
...
!p{formula} $!B$ less complex than $!A$. The induction step proceeds
...
proof of the reverse direction is symmetrical.
