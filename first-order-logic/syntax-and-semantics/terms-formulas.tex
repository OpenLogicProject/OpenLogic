...
been included as zero-place !p{function}.  We could then do without
...
\tagitem{prvAnd}{If $!A$ and $!B$ are !p{formula}, then $(!A \land
  !B)$ is a !!{formula}.}{}

\tagitem{prvOr}{If $!A$ and $!B$ are !p{formula}, then $(!A \lor !B)$
  is a !!{formula}.}{}

\tagitem{prvIf}{If $!A$ and $!B$ are !p{formula}, then $(!A \lif !B)$
  is a !!{formula}.}{}

\tagitem{prvIff}{If $!A$ and $!B$ are !p{formula}, then $(!A \liff !B)$
  is a !!{formula}.}{}
...
to count as 
\iftag{notprvEx,notprvAll}{a !!{formula}}{!p{formula}}.
Nothing bad happens if you don't require this, and it makes things
easier.
\end{intro}

\begin<definedSyms>{defn}
\begin{tagenumerate}{defTrue,defFalse,defNot,defOr,defAnd,defIf,
    defIff,defEx,defAll}

\tagitem{defTrue}{$\ltrue$ abbreviates
  \iftag{prvFalse}{$\lnot\lfalse$}{$(!A \land \lnot !A)$ for some
    fixed atomic !!{formula}~$!A$}.}{}

\tagitem{defFalse}{$\lfalse$ abbreviates
  \iftag{prvTrue}{$\lnot\ltrue$}{$(!A \lor \lnot !A)$ for some
    fixed atomic !!{formula}~$!A$}.}{}
