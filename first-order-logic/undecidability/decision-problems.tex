...
(sets) formulas or relationsbetween them.  The definitions of these
logical notionsprovide \emph{criteria} for when, say, a sentence is
valid. (In this case, it is valid iff it is true in every first-order
...
A decision problem can therefore be shown to be unsolvable bu reducing
