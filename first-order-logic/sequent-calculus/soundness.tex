...
\item The last inference is $\lnot$~right: similarly.
...
\item The last inference is $\lexists$~right: similarly.
...
\item The last inference is $\lexists$~left: similarly.
\end{enumerate}
...
\item The last inference is $\land$~right. The premises are $\Gamma
  ...
  \in \Delta$.
\item The last inference is $\lor$~left: similarly.
