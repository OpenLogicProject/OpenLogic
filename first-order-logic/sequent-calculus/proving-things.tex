...
Now looking at the left branch, the only logical connective in any !!{formula} is the $\lnot$ symbol in the antecedent !p{formula}, so we're looking at an instance of the $\lnot$ left rule.
...
\RightLabel{$\lexists$ left} \UnaryInf$ \lexists[x] \lnot F(x) \fCenter \lnot \lforall[x] F(x)$
\end{prooftree}
...
\RightLabel{$\lnot$ right} \UnaryInf$ \fCenter \lnot \lforall[x] F(x), F(a)$
\RightLabel{$\lnot$ left} \UnaryInf$ \lnot F(a) \fCenter \lnot \lforall[x] F(x)$
\RightLabel{$\lexists$ left} \UnaryInf$ \lexists[x] \lnot F(x) \fCenter \lnot \lforall[x] F(x)$
\end{prooftree}
...
\RightLabel{$\lforall$ left} \UnaryInf$\lforall[x] F(x) \fCenter F(a)$
\RightLabel{$\lnot$ right} \UnaryInf$ \fCenter \lnot \lforall[x] F(x), F(a)$
\RightLabel{$\lnot$ left} \UnaryInf$ \lnot F(a) \fCenter \lnot \lforall[x] F(x)$
\RightLabel{$\lexists$ left} \UnaryInf$ \lexists[x] \lnot F(x) \fCenter \lnot \lforall[x] F(x)$
\end{prooftree}
