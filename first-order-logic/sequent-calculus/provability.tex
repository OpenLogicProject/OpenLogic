...
\item There is an $\Log{LK}$-derivation $\Pi_0$ and a finite set
  $\Gamma_0 \subseteq \Gamma$ such that we can derive
...
\item If $\Gamma \Proves[\Log{LK}] !A \land !B$, there is a finite set
...
\item If $\Gamma \Proves[\Log{LK}] !A$ as well as $\Gamma
  \Proves[\Log{LK}] !B$, there are finite sets $\Gamma_0$, $\Gamma_1
  \subseteq \Gamma$ and an $\Log{LK}$-derivations $\Pi_0$ of $\Gamma_0
  \Sequent !A$ and $\Pi_1$ of $\Gamma_1
  \Sequent !A$. Consider
...
% prop:provability-mp
\item Suppose that $\Gamma \Proves[\Log{LK}] !A$
  and $\Gamma \Proves[\Log{LK}] !A \lif !B$.
There are finite sets $\Gamma_0$, $\Gamma_1 \subseteq \Gamma$
such that there are $\Log{LK}$-derivations $\Pi_0$ of $\Gamma_0
\Sequent !A$ and  $\Pi_1$ of $\Gamma_1
\Sequent !A \lif !B$. Consider:
...
\item First suppose $\Gamma \Proves[\Log{LK}] \lnot !A$.  Then for
  some finite $\Gamma_0 \subseteq \Gamma$ there is a
  $\Log{LK}$-derivation of $\Gamma_0 \Sequent \lnot !A$. The following
  derivation shows that $\Gamma \Proves[\Log{LK}] !A \lif !B$:
