...
saturated.  By \olref[mod]{lem:truth} If $\Gamma$ does not contain
$\eq$, then by \olref[mod]{lem:truth}, $\Sat{M(\Gamma^*)}{!A}$ iff $!A
\in \Gamma^*$.  From this it follows in particular that for all $!A
\in \Gamma$, $\Sat{M(\Gamma^*)}{!A}$, so $\Gamma$ is satisfiable.  If
$\Gamma$ does contain $\eq$, then by \olref[ide]{lem:truth},
