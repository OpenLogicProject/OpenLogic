...
\tagitem{fnTerms}{\indcase{s}{\Atom{f}{t_1, \dots, t_n}}{$\Subst{\indfrmp}{t}{x}$ is
...
\item $\Obj v_8$ is \emph{not} free for $\Obj v_1$ in $\lexists[\Obj
  v_8](\Atom{\Obj A^2_4}{\Obj v_3,\Obj v_1} \lif \Atom{\Obj A^1_1}{\Obj v_8})$.
\tagitem{fnTerms}{$\Obj f^2_1(\Obj v_1, \Obj v_2)$ is \emph{not} free for $\Obj
