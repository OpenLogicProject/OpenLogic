...
\begin{defn}
A \emph{configuration} of Turing machine $M = \tuple{Q, \Sigma, s,
I}$ is a triple $\tuple{C, n, q}$ where
\begin{enumerate}
...
\item the instruction set of $M$ contains a tuple $\tuple{q, \sigma,
  q', \sigma', D}$,
\item the $n$-th symbol of $C'$ is $\sigma'$,
\item
\begin{enumerate}
...
\tuple{\TMendtape \frown O, n, h}$.  In that case the
