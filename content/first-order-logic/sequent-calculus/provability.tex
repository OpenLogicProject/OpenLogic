...
\begin<prvOr>{prop}
\ollabel{prop:provability-lor-left} If $\Gamma \cup \{!A\}$ and
...
\Deduce$!A, \Gamma_0 \fCenter $
\doubleLine
\UnaryInf$!A, \Gamma_0, \Gamma_1 \fCenter $
\AxiomC{}
\RightLabel{$\pi_1$}
\Deduce$!B, \Gamma_1 \fCenter $
\doubleLine
\UnaryInf$!B, \Gamma_0, \Gamma_1 \fCenter $
\RightLabel{\LeftR{\lor}}
\BinaryInf$ !A \lor !B, \Gamma_0, \Gamma_1 \fCenter $
\end{prooftree}
