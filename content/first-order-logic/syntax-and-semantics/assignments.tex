...
!!a{constant} or one one of the variables~$x_1$, \dots,~$x_n$.}{}
If $t = c$, then $\Value{t}{M}[s_1] = \Assign{c}{M} = \Value{t}{M}[s_2]$. 
If $t = x_i$, $s_1(x_i) = s_2(x_i)$ by the hypothesis of the proposition,
...
Suppose $\Lang L$ is a first-order language\iftag{fnTerms}{ without !!{function}s}{}. Given a
