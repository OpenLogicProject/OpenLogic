...
are formed from !!{variable}s\iftag{fnTerms}{,}{ and} 
!!{constant}s\iftag{fnTerms}{, and !!{function}s}{}.
...
are assigned elements in the domain\iftag{fnTerms}{, !!{function}s are assigned
