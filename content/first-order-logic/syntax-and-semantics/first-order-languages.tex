...
containing \emph{!!{variable}s}, \emph{!!{constant}s}, \iftag{fnTerms}{}{and }
\emph{!!{predicate}s}\iftag{fnTerms}{ and sometimes \emph{!!{function}s}}{}.
...
\iftag{fnTerms}{}{and } !!{constant}s are names for individual objects
\iftag{fnTerms}{, and !!{function}s are names for mappings}{}.   
...
!!{predicate}s, \iftag{fnTerms}{}{and }!!{constant}s\iftag{fnTerms}{,
 and !!{function}s}{}.
...
Again, these are conventions: officially, these are just aliases,
e.g., $\in$, and $\le$ are aliases for $\Obj A^2_0$.
}
