...
\iftag{defEx,defAll}{}{\begin{enumerate}\item}%
\iftag{prvEx}{$\Sat{M(\Gamma^*)}{\lexists[x][!A(x)]}$ iff
  $\Sat{M}{!A(t)}$ for at least one term~$t$.}{}%
\iftag{defEx,defAll}{}{\item}%
\iftag{prvAll}{$\Sat{M(\Gamma^*)}{\lforall[x][!A(x)]}$ iff
  $\Sat{M}{!A(t)}$ for all terms~$t$.}{}%
\iftag{defEx,defAll}{}{\end{enumerate}}
\end{prop}
...
\iftag{prvAll}{%
  \iftag{probAll}{Exercise.}{By \olref[syn][ass]{prop:sat-quant},
    ...
    since $!A(t)$ is a sentence.}}{} \iftag{defAll,defEx}{}{\item}
\iftag{prvEx}{%
