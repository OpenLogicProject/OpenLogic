...
\iftag{prvEx}{$\lexists[x][!A(x)] \in \Gamma$ iff $!A(t) \in \Gamma$
  ...
  \iftag{prvAll}{%
    \iftag{probAll}{Exercise.}{Suppose that $!A(t) \in \Gamma$ for
      ...
      \iftag{prvEx}{\lexists[x][\lnot !A(x)] \lif \lnot
        ...
        !A(c)}, !A(c) \Proves \lfalse.)
      \]

      For the reverse direction, we do not need saturation: Suppose
      $\lforall[x][!A(x)] \in \Gamma$. Since $\lforall[x][!A(x)]
      \Proves !A(t)$, $!A(t) \in \Gamma$ by \olref[ccs]{prop:ccs}.}}{}
  \iftag{defAll,defEx}{}{\item}
  \iftag{prvEx}{%
    ...
    $!A(t) \in \Gamma$. Then $!A(t) \Proves \lexists[x][!A(x)]$ and by
