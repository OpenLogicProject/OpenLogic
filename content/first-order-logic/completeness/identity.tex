...
\begin{defn}
  ...
  \iftag{cmplCCS}{consistent and !!{complete}}{}
  set of sentences in~$\Lang L$.  We define the relation $\approx$ on
  the set of closed terms of~$\Lang L$ by
  \[
...
\begin{proof}
  ...
  \iftag{cmplMCS}{maximally consistent,}{}
  \iftag{cmplCCS}{consistent and complete,}{}
  $\eq[t][t'] \in \Gamma^*$ iff $\Gamma^* \Proves \eq[t][t']$.  Thus
