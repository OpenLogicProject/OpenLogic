...
\ollabel{lem:lindenbaum} Every consistent set~$\Gamma'$ in a
...
\tagrefs{prfAX/{fol:axd:prv:prop:explicit-inc},prfSC/{fol:seq:prv:prop:explicit-inc},prfND/{fol:ntd:prv:prop:explicit-inc},prfTab/{fol:tab:prv:prop:explicit-inc}},
...
\tagrefs{prfAX/{fol:axd:ptn:prop:proves-compact},prfSC/{fol:seq:ptn:prop:proves-compact},prfND/{fol:ntd:ptn:prop:proves-compact},prfTab/{fol:tab:ptn:prop:proves-compact}},
$\Gamma^*$ is consistent.
