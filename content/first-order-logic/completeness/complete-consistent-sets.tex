...
\tagrefs{prfAX/{fol:axd:ptn:sec},prfSC/{fol:seq:ptn:sec},prfND/{fol:ntd:ptn:sec}}).
...
By
\tagrefs{prfAX/{fol:axd:prv:prop:explicit-inc},prfSC/{fol:seq:prv:prop:explicit-inc},prfND/{fol:ntd:prv:prop:explicit-inc}},
...
by
\tagrefs{prfAX/{fol:axd:ppr:prop:provability-land},prfSC/{fol:seq:ppr:prop:provability-land},prfND/{fol:ntd:ppr:prop:provability-land}}, item~(1),
...
\Gamma$. By
\tagrefs{prfAX/{fol:axd:ppr:prop:provability-land},prfSC/{fol:seq:ppr:prop:provability-land},prfND/{fol:ntd:ppr:prop:provability-land}}, item~(2),
...
\tagrefs{prfAX/{fol:axd:ppr:prop:provability-lor},prfSC/{fol:seq:ppr:prop:provability-lor},prfND/{fol:ntd:ppr:prop:provability-lor}},
...
\Gamma$. By
\tagrefs{prfAX/{fol:axd:ppr:prop:provability-lor},prfSC/{fol:seq:ppr:prop:provability-lor},prfND/{fol:ntd:ppr:prop:provability-lor}}, item (2),
...
\tagrefs{prfAX/{fol:axd:ppr:prop:provability-lif},prfSC/{fol:seq:ppr:prop:provability-lif},prfND/{fol:ntd:ppr:prop:provability-lif}}, item (1),
...
\tagrefs{prfAX/{fol:axd:ppr:prop:provability-lif},prfSC/{fol:seq:ppr:prop:provability-lif},prfND/{fol:ntd:ppr:prop:provability-lif}}, item (2),
...
\tagrefs{prfAX/{fol:axd:ppr:prop:provability-lif},prfSC/{fol:seq:ppr:prop:provability-lif},prfND/{fol:ntd:ppr:prop:provability-lif}},
