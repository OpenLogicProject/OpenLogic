...
formula $\phi(x)$.\footnote{In keeping with the convention noted at the start of \olref[sth][][]{part}, $\phi$ may have parameters; for an explanation of
	what this means, see the discussion immediately after
	\olref[sfr][infinite][induction]{natinductionschema}.} The scheme can equally well be (and normally is) written down
as follows:
