...
\begin{align*}
	\tau_0(A) & \coloneq \card{A}\\
	\tau_{n+1}(A) & \coloneq \beth_{\tau_n(A)}\\
	\tau(A) & \coloneq \bigcup_{n < \omega}\tau_n(A)
...
So now consider this recursive definition:}
	W_0 &\coloneq 0\\
	W_{\alpha + 1} & \coloneq \tau(W_\alpha)\\
	W_\alpha & \coloneq \bigcup_{\beta < \alpha} W_\beta
