...
\begin{defn}
  ...
  \item 
    ...
    then $\Gn{\delta}$ is $\tuple{1, \Gn{\delta_1}, \Gn{!A}, n, k}$,
    $\tuple{2, \Gn{\delta_1}, \Gn{\delta_2}, \Gn{!A}, n, k}$, or
    $\tuple{3, \Gn{\delta_1}, \Gn{\delta_2}, \Gn{\delta_3}, \Gn{!A}, n,
      k}$, respectively.  Here $\delta_1$, $\delta_2$, $\delta_3$ are the
...
\begin{prop}
  The relation $\fn{Correct}(d)$ which holds if the last inference in
