...
\begin{prob}
 Where `$\circ_7$' has the characteristic truth table defined in the proof of \olref{thm:Ampheck}, show that the following are jointly expressively adequate:
	\begin{enumerate}
...
\begin{prob}
Complete the proof of \olref{thm:expressive}.
\end{prob}
