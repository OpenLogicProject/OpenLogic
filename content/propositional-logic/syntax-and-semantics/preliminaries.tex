...
\emph{Principle of induction on !!{formula}s}: If some
  ...
  \begin{enumerate}
    \tagitem{prvNot}{it holds for $\lnot !A$ whenever it holds
      for~$!A$;}{}
    \tagitem{prvAnd}{if holds for and $(!A \land !B)$
      whenever it holds for $!A$ and $!B$;}{}
    \tagitem{prvOr}{if holds for and $(!A \lor !B)$
      whenever it holds for $!A$ and $!B$;}{}
    \tagitem{prvIf}{if holds for and $(!A \lif !B)$
      whenever it holds for $!A$ and $!B$;}{}
    \tagitem{prvIff}{if holds for and $(!A \liff !B)$
      whenever it holds for $!A$ and $!B$;}{}
  \end{enumerate}
...
\begin{prob} 
Prove \olref[prp][syn][pre]{prop:balanced}
\end{prob}
...
\begin{prob}
  Prove \olref[prp][syn][pre]{prop:noinit}
\end{prob}
...
\tagitem{prvAnd}{$(!B \lor !C)$ for some !!{formula}s $!B$ and~$!C$.}{}

\tagitem{prvAnd}{$(!B \lif !C)$ for some !!{formula}s $!B$ and~$!C$.}{}

\tagitem{prvAnd}{$(!B \liff !C)$ for some !!{formula}s $!B$ and~$!C$.}{}
\end{enumerate}
