...
the construction:\footnote{For credit on these pictures: Aristid
Lindenmayer developed the Lindenmayer System for describing models of
growth, which has here been implemented in the lindenmayersystems
library for TikZ. I was also inspired by the Wikipedia entry on
\href{http://en.wikipedia.org/wiki/Space-filling_curve}{space-filling
curves}.}
\begin{center}
\begin{tikzpicture}
