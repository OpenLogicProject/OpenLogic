...
you simply have to do two things: prove $p$, and then prove $q$. Bou
...
The trick is to maintain generality throughout the proof. Bou start by
...
true.  Bou want to prove $r$.  Bou do this in two steps: first you
...
from this.  Bou would write ``We distinguish cases'' under the
...
are things to which that name might refer. Bou might of course not be
