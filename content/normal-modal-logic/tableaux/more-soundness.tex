...
\tagitem{prvDiamond}{The branch is expanded by applying T$\Diamond$ to
  ...
  \iftag{probDiamond}{Exercise.\qedhere}{This results in a new !!{signed
      formula}~$\sFmla{\False}{!B}[\sigma]$ on the branch. Suppose
    $\mSat{M}{\Gamma}[f]$, in particular, $\mSat/{M}{\Diamond
      !B}[f(\sigma)]$. Since $R$ is reflexive, we know that
    $Rf(\sigma)f(\sigma)$.  Hence, $\mSat/{M}{!B}[f(\sigma)]$, i.e.,
    $\mModel{M}, f$ satisfies $\sFmla{\False}{!B}[\sigma]$.\qedhere}}{}
\end{tagenumerate}
\end{proof}

\tagprob{probBox,probDiamond}
\begin{prob}
  Complete the proof of \olref[mod][tab][msn]{prop:soundness-T}
\end{prob}
\tagendprob
...
\tagitem{prvDiamond}{The branch is expanded by applying D$\Diamond$ to
  ...
  \iftag{probDiamond}{Exercise.\qedhere}{This results in a new !!{signed
    ...
    satisfies $\sFmla{\False}{\Box!B}[\sigma]$.\qedhere}}{}
\end{tagenumerate}
\end{proof}

\tagprob{probBox,probDiamond}
\begin{prob}
  Complete the proof of \olref[mod][tab][msn]{prop:soundness-D}
\end{prob}
\tagendprob
...
\tagitem{prvDiamond}{The branch is expanded by applying B$\Diamond$ to
  ...
  \iftag{probDiamond}{Exercise.\qedhere}{This results in a new !!{signed
    ...
    $\mSat/{M}{!B}[f(\sigma)]$. Hence, $\mModel{M}, f$ satisfies
    $\sFmla{\False}{!B}[\sigma]$.\qedhere}}{}
\end{tagenumerate}
\end{proof}

\tagprob{probBox,probDiamond}
\begin{prob}
  Complete the proof of \olref[mod][tab][msn]{prop:soundness-B}
\end{prob}
\tagendprob
...
\tagitem{prvDiamond}{The branch is expanded by applying 4$\Diamond$ to
  ...
  \iftag{probDiamond}{Exercise.\qedhere}{This results in a new !!{signed
    ...
    $\mModel{M}, f$ satisfies $\sFmla{\False}{\Diamond !B}[\sigma.n]$.\qedhere}}{}
\end{tagenumerate}
\end{proof}

\tagprob{probBox,probDiamond}
\begin{prob}
  Complete the proof of \olref[mod][tab][msn]{prop:soundness-4}
\end{prob}
\tagendprob
...
\tagitem{prvDiamond}{The branch is expanded by applying 4r$\Diamond$ to
  ...
  \iftag{probDiamond}{Exercise.\qedhere}{This results in a new !!{signed
    ...
    $\sFmla{\False}{\Diamond !B}[\sigma]$.\qedhere}}{}
\end{tagenumerate}
\end{proof}

\tagprob{probBox,probDiamond}
\begin{prob}
  Complete the proof of \olref[mod][tab][msn]{prop:soundness-4r}
\end{prob}
\tagendprob
