...
characterized as the !!{formula}s valid on all refelxive, symmetric,
...
\begin{prob}
  Prove \olref[mod][syn][es5]{prop:equivalences} by showing:
  \begin{enumerate}
  ...
  \item If $R$ is serial, symmetric, and transitive, it is refelxive.
  \end{enumerate}
...
\olref[prf][prs]{prop:S5}, in that it gives equivalent characterization of
...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[node distance=2cm, auto, thick]
    ...
    \node at (4.75,2) {$[z]$} ;
  \end{tikzpicture}
  \caption{A partition of $W$ in equivalence classes.}\ollabel{fig:partition}
\end{figure}
