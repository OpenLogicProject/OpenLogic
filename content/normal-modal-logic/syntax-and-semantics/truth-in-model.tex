...
\begin{prob}
  ...
  \begin{center}
    \begin{tikzpicture}[modal]
      \node[world] (w1) [label=above:$w_1$] {$p_1$} ; 
      \node[world] (w2) [label=below:$w_2$, below right=of w1,font=\tiny]  {$p_1, p_2$}; 
      \node[world] (w3) [label=above:$w_3$, above right=of w2,font=\tiny] {$p_1\, p_2\, p_3$};
