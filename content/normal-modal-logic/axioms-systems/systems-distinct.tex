...
\begin{figure}[htpb]
  ...
  \begin{tikzpicture}[modal]
    \node (w1) [label=above:\mFalse{p},
    label={below:$\mSat{}{\Box p}$\\ $\mSat/{}{\Box\Box p}$}] {$w_1$}; 
    \node (w2) [label=above:\mTrue{p},
...
\begin{figure}[htpb]
  \centering
  \begin{tikzpicture}[modal]
    \node (w1) [label={right:\mTrue{p}}, label={below: $\mSat{}{\Box p}$\\
        $\mSat/{}{\Box\Box p}$\\
        $\mSat/{}{\Diamond\lnot p}$}] {$w_1$};
    \draw[reflexive above] (w1) to (w1);
    \node (w2) [label={right:\mTrue{p}}, label={below:
        $\mSat{}{\Diamond\lnot p}$\\
        $\mSat/{}{\Box\Diamond\lnot p}$}, right=of w1] {$w_2$} ;
    \draw[reflexive above] (w2) to (w2);
    \node (w3) at (4, 0) [label={right:\mFalse{p}},right=of w2] {$w_3$};
    \draw[reflexive above] (w2) to (w2);
    \draw[->, bend left] (w1) to (w2);  
...
\begin{figure}[t]
  \centering
  \begin{tikzpicture}[modal]
    \node (w2) [label=north west:\mTrue{p}]{$w_2$} ;
    \draw[reflexive left] (w2) to (w2);
    \node (w1) [label=right:\mFalse{p},
      label=below:{$\mSat{}{\Box p}, \mSat/{}{\Box\Box p}$},
      below right=of w2]{$w_1$};
    \node (w3) [label=north east:\mTrue{p}, above right=of w1]{$w_3$} ;
    \draw[reflexive right] (w3) to (w3);
    \node (w4) [label=right:\mFalse{p},above right=of w2]{$w_4$};
