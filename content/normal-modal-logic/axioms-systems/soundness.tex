...
\begin{thm}[Soundness Theorem]\ollabel{thm:soundness}
  If $!A_1$, \dots, $!A_n$ are valid in the
...
\begin{proof}
  ...
  \item Induction Basis: If $!B$ has a proof of length~$1$, then it is
    either a tautological instance, an instance of \Ax{K} or \Dual{},
    ...
    \olref[syn][tau]{prop:valid-taut}. Similarly in the second case, by
    \olref[syn][sch]{prop:Kvalid} and
