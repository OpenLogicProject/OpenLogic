...
\begin{prob}
  Prove \olref[mod][prf][der]{prop:rewriting} by proving, by induction
...
\begin{proof}
  ...
  instances of instances of \Dual{} and~\Ax{K} are themselves
  instances of \Dual{} and~\Ax{K}, and applications of \MP{}
