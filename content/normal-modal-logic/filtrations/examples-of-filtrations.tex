...
\begin{prob}
  ...
  = \Bin^* \setminus \Setabs{1\sigma}{\sigma \in \Bin^*} \setminus
  \{\emptyseq\}$, the set of sequences of $0$s and~$1$s starting
  with~$0$, with $R\sigma\sigma'$ iff $\sigma' = \sigma 0$ or $\sigma'
  = \sigma 1$, and $V(p) = \Setabs{\sigma 0}{\sigma \in \Bin^*}$ and
  $V(q) = \Setabs{\sigma 1}{\sigma \in \Bin^* \setminus
    \{1\}}$. Here's a picture:
  \begin{center}
    \begin{tikzpicture}[modal,
        node distance=2cm
