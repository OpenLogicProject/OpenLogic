...
\begin{ex}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[modal]
      \node[world] (1) [label=below:{$1$}] {};
      \node[world] (2) [label=below:{$2$}, right=of 1] {$p$};
      \node[world] (3) [label=below:{$3$}, right=of 2] {};
      \node[world] (4) [label=below:{$4$}, right=of 3] {$p$};
      \node (5) [right=of 4] {};
      \draw[->] (1) to (2);
      \draw[->] (2) to (3);
      \draw[->] (3) to (4);
    ...
    \begin{tikzpicture}[modal]
      ...
      \node[world] (3) [label=below:{$[1]$},right=of 2] {};
      \node[world] (4) [label=below:{$[2]$}, right=of 3] {$p$};
...
\begin{prob}
  ...
  \begin{center}
    \begin{tikzpicture}[modal]
      ...
      \node[world] (0) [label=below:{$0$}] {$p$};
      \node[world] (00) [label=below:{$00$}, above right=of 0] {$p$};
      \node[world] (000) [label=below:{$000$}, right=of 00, yshift=.7cm] {$p$};
      \node(0000) [right=of 000, yshift=.5cm] {};
      \node(0001) [right=of 000, yshift=-.5cm] {};
      \node[world] (001) [label=below:{$001$}, right=of 00, yshift=-.7cm] {$q$};
      \node(0010) [right=of 001, yshift=.5cm] {};
      \node(0011) [right=of 001, yshift=-.5cm] {};
      \node[world] (01) [label=below:{$01$}, below right=of 0] {$q$};
      \node[world] (010) [label=below:{$010$}, right=of 01, yshift=.7cm] {$p$};
      \node(0100) [right=of 010, yshift=.5cm] {};
      \node(0101) [right=of 010, yshift=-.5cm] {};
      \node[world] (011) [label=below:{$011$}, right=of 01, yshift=-.7cm] {$q$};
      \node(0110) [right=of 011, yshift=.5cm] {};
      \node(0111) [right=of 011, yshift=-.5cm] {};
