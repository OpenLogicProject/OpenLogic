...
% restore colored links after the TOC
...
\olimport*[first-order-logic/tableaux]{quantifier-rules}

\olimport*[first-order-logic/tableaux]{proving-things-quant}

\olimport*[first-order-logic/tableaux]{provability-quantifiers}

\olimport*[first-order-logic/tableaux]{soundness}

\olimport*[first-order-logic/tableaux]{identity}
\olimport*[first-order-logic/tableaux]{soundness-identity}
