...
\olref{prop:derivfacts}, part (c) and monotony, $\Gamma \cup
...
\olref{prop:consistent} part \olref{prop:consistent:3}, $\Gamma
...
\begin{proof}
From \olref{prop:proves} we have that if $\Gamma \cup \{\lnot !A\}$ is
